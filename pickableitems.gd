...
const WEAPONS = [
	{"name": "Black Sword", "type": "weapon", "texture_path": "res://Sword Pack/Black Sword.png", "damage": 30, "swing_speed": 1.2, "scale": 4.0, "pickup_scale": 1.0, "attack_type": "swing"},
...
func _ready() -> void:
	var randomnum = WEAPONS[randi_range(0, 6)]
	if randomnum%2==1:
		item_data=WEAPONS[0]
	elif randomnum%2==0:
		item_data=WEAPONS[1]
